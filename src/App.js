...
export default function App() {
    ...
    return (_jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/register", element: _jsx(Register, {}) }), _jsx(Route, { path: "/", element: isAuth ? _jsx(Home, {}) : _jsx(Register, {}) }), _jsx(Route, { path: "/test/:id", element: _jsx(Test, {}) })] }) }));
}
