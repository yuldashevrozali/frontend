...
export default function TakeTest() {
    ...
    if (result) {
        return (_jsxs("div", { className: "p-4 max-w-md mx-auto text-center", children: [_jsx("div", { className: "text-6xl mb-4", children: "\uD83D\uDCCA" }), _jsx("h2", { className: "text-2xl font-bold mb-4", children: "Natija" }), _jsxs("div", { className: "text-4xl font-bold text-blue-500 mb-2", children: [result.score, " / ", result.total] }), _jsxs("p", { className: "text-gray-500 mb-6", children: ["Siz ", result.total, " ta savoldan ", result.score, " tasini to'g'ri javob berdingiz"] }), _jsx("button", { onClick: () => navigate('/'), className: "w-full bg-blue-500 text-white p-3 rounded-lg font-semibold", children: "\uD83C\uDFE0 Bosh sahifaga qaytish" })] }));
    }
    if (!test) {
