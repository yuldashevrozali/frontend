    ...
    return (_jsxs("div", { style: { padding: '16px', paddingBottom: '120px' }, children: [_jsxs("div", { style: {
                    ...
                    border: '1px solid rgba(255,255,255,0.12)',
                                ...
                                padding: '12px',
                                                        ...
                                                        whiteSpace: 'nowrap',
                                                    }, children: answers[`${q}.1`] || _jsx("span", { style: { opacity: 0.4 }, children: ".1" }) }), _jsx("button", { onClick: () => openKeyboard(`${q}.1`), style: {
                                                        width: '44px',
                                                        background: 'rgba(255,255,255,0.1)',
                                                        borderRadius: '12px',
                                                        border: 'none',
                                                        ...
                                                        textOverflow: 'ellipsis',
                                                        whiteSpace: 'nowrap',
                                                    }, children: answers[`${q}.2`] || _jsx("span", { style: { opacity: 0.4 }, children: ".2" }) }), _jsx("button", { onClick: () => openKeyboard(`${q}.2`), style: {
                                                        width: '44px',
                                                        background: 'rgba(255,255,255,0.1)',
                                                        borderRadius: '12px',
                                                        border: 'none',
                                                        ...
                                                        alignItems: 'center',
                                                        justifyContent: 'center',
                                                    }, children: "\u2328" })] })] })] }, q))) })] }), showKeyboard && (_jsx(MathKeyboard, { onInput: handleKeyboardInput, onClose: () => { setShowKeyboard(false); setActiveInput(null); } })), _jsx("button", { onClick: submitTest, disabled: loading, style: {
                    width: '100%',
                    padding: '18px',
