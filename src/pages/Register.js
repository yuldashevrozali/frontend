...
export default function Register() {
    ...
    if (registered) {
        return (_jsxs("div", { className: "p-4 max-w-md mx-auto text-center", children: [_jsx("div", { className: "text-6xl mb-4", children: "\uD83C\uDF89" }), _jsxs("h2", { className: "text-2xl font-bold mb-2", children: ["Xush kelibsiz, ", userName, "!"] }), _jsx("p", { className: "text-gray-500 mb-6", children: "Siz muvaffaqiyatli ro'yxatdan o'tdingiz." }), _jsx("p", { className: "text-sm text-blue-500", children: "Web App yopilmoqda..." })] }));
    }
