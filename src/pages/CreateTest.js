...
export default function CreateTest() {
    ...
    return (_jsxs("div", { style: { padding: '16px', paddingBottom: '120px' }, children: [_jsxs("div", { style: {
                    ...
                    border: '1px solid rgba(255,255,255,0.12)',
                                ...
                                borderRadius: '14px',
                                padding: '12px',
                            }, children: [_jsx("span", { style: { opacity: 0.6, width: '40px', textAlign: 'center', fontFamily: 'monospace', fontSize: '16px' }, children: q }), _jsxs("div", { style: { display: 'flex', gap: '8px', flex: 1 }, children: [_jsxs("div", { style: { display: 'flex', flex: 1, gap: '4px' }, children: [_jsx("button", { onClick: () => openKeyboard(`${q}.1`), style: {
                                                        flex: 1,
                                                        padding: '14px 10px',
                                                        ...
                                                        whiteSpace: 'nowrap',
                                                    }, children: answerKeys[`${q}.1`] || _jsx("span", { style: { opacity: 0.4 }, children: ".1" }) }), _jsx("button", { onClick: () => openKeyboard(`${q}.1`), style: {
                                                        width: '44px',
                                                        ...
                                                        alignItems: 'center',
                                                        justifyContent: 'center',
                                                    }, children: "\u2328" })] }), _jsxs("div", { style: { display: 'flex', flex: 1, gap: '4px' }, children: [_jsx("button", { onClick: () => openKeyboard(`${q}.2`), style: {
                                                        flex: 1,
                                                        padding: '14px 10px',
                                                        ...
                                                        textOverflow: 'ellipsis',
                                                        whiteSpace: 'nowrap',
                                                    }, children: answerKeys[`${q}.2`] || _jsx("span", { style: { opacity: 0.4 }, children: ".2" }) }), _jsx("button", { onClick: () => openKeyboard(`${q}.2`), style: {
                                                        width: '44px',
                                                        background: 'rgba(255,255,255,0.1)',
                                                        borderRadius: '12px',
                                                        border: 'none',
                                                        ...
                                                        alignItems: 'center',
                                                        justifyContent: 'center',
                                                    }, children: "\u2328" })] })] })] }, q))) })] }), showKeyboard && (_jsx(MathKeyboard, { onInput: handleKeyboardInput, onClose: () => { setShowKeyboard(false); setActiveInput(null); } })), _jsx("button", { onClick: handleSubmit, disabled: loading || !allRequiredFilled, style: {
                    width: '100%',
                    padding: '18px',
